...
1. Figures folder (DOCNAME/figures/): Your figures in the permitted formats (see below, including any .tex sources for TikZ illustrations). During manuscript preparation the file names of the figures must reflect their contents. Your figure files must be generated using the data in the Data folder using functions in the code folder during the generation of figures. It is the only way to ensure compliance with condition listed below for the code folder.
