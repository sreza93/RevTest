...
% PREAMBLE starts here. You cannot make any changes until the PREAMBLE ends. It will be marked where it ends.
...
% PREAMBLE ends here. You can make changes starting here.
...
\textcolor{purple}{\textsc{Checklist for you to follow before sending me the any draft (DO NOT DELETE until we are ready to submit this):
\begin{enumerate}
\item Have you read the \textbf{entire} README file in the manuscript repo?
...
\item Have you ensured that you are using exactly zero absolute references when referring to figures, tables, etc.? If you see usage like "Fig.~(1)", I will refuse to entertain the manuscript any further. Lose any brain dead Microsoft Word habits you might have.
\item Have you ensured that you are not using any figure placement modifiers like "h", "t", etc. Please lose any brain dead Microsoft Word habits you might have. \textbf{\LaTeX\ } decide where each figure will go. No, let it decide and get your meddling fingers away from document beautification and focus on the \textbf{content}. 
